...
<div class={cn("flex flex-col gap-6", className)} {...restProps}>
	<Card.Root>
		<Card.Header class="text-center">
			...
			<Card.Description>Login with your Github, Google or Discord account</Card.Description>
		</Card.Header>
		<Card.Content>
			<form method="POST">
				<FieldGroup>
					...
					<Field>
						...
						<Button variant="outline" type="button" class="h-12" onclick={loginWithGithub}>
							<svg fill="#000000" width="800px" height="800px" viewBox="0 -0.5 25 25" xmlns="http://www.w3.org/2000/svg">
								<title>github</title>
						...
						<Button variant="outline" type="button" class="h-12" onclick={loginWithGoogle}>
						...
						<Button variant="outline" type="button" class="h-12" onclick={loginWithDiscord}>
							<svg fill="#000000" width="800px" height="800px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
							<title>discord</title>
