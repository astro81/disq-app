<!-- /(app)/discovery/servers/+page.svelte -->
<script lang="ts">
	import { getServerList, getServerMembersCount, getServerMetadata } from '$lib/remote/server.remote';
...
{#if isPopupOpen && selectedServer}
    ...
    <!-- Popup positioned beside hover button -->
    <div
