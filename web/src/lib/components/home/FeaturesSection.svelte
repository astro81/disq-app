...
<section bind:this={sectionEl} id="features" class="py-32 relative overflow-hidden">
	<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
		<div bind:this={headingEl} class="mx-auto max-w-2xl text-center mb-20">
		...
		>
			{#each features as feature, index (index)}
				<div
					...
					class="group relative rounded-2xl border border-border bg-card/50 backdrop-blur-sm p-8 transition-colors duration-300 hover:border-green-500/60 hover:bg-card cursor-pointer"
